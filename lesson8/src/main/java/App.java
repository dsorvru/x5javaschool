...
public class App {
    ...
    private static final String CONNECTION_URL = "jdbc:h2:mem:test;INIT=RUNSCRIPT FROM './schema.sql'\\;RUNSCRIPT FROM './data.sql'";
    ...
    private static final String QUIT_COMMAND = "quit";
        ...
        public static void main(String[] args) {
            ...
            try (Connection connection = DriverManager.getConnection(CONNECTION_URL);
                ...
                AccountService service = new DBAccountService(connection);
                printHelp();
